...
<body id="home">
    ...
    <!-- banner -->
    <div class="banner">
        <img src="images/photos/banner.png" class="img-responsive" alt="slide">
        <div class="welcome-message">
            <div class="wrap-info">
                <div class="information">
                    <h1 class="animated fadeInDown" style="color:black">LAUNDRY WISMA </h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5 col-md-4">
                    <h4>1 kg baju Rp.4000</h4>
                    <h4>1 pasang sepatu Rp.15000</h4>
                    <h3>Berlangganan Sekarang</h3>
                    <form id="form" class="wowload fadeInRight" method="POST">
                        ...
                        <div class="form-group">
                            <input type="berat" class="form-control" id="berat" name="berat" placeholder="berat">
                        </div>
                        <div class="form-group">
                            <input type="jenis" class="form-control" id="jenis" name="jenis" placeholder="jenis">
                        </div>
    ...
    <!-- reservation-information -->
    <div class="text-center copyright">My Project 2022@aris rifaldi</div>
